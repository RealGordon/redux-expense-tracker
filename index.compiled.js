(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
    ...
    exports["default"] = exports.selectBudgets = exports.editBudget = exports.CATEGORIES = void 0;
    ...
    var budgetsSlice = (0, _toolkit.createSlice)({
      ...
      reducers: {
        editBudget: function editBudget(state, action) {
          var index = state.findIndex(function (budget) {
    ...
    */
    ...
    exports.selectFlattenedTransactions = exports.selectTransactions = exports["default"] = exports.deleteTransaction = exports.addTransaction = exports.CATEGORIES = void 0;
    ...
    var transSlice = (0, _toolkit.createSlice)({
      name: "transactions",
      initialState: initialState,
      reducers: {
    ...
    var _transSlice$actions = transSlice.actions,
        addTransaction = _transSlice$actions.addTransaction,
        deleteTransaction = _transSlice$actions.deleteTransaction;
    exports.deleteTransaction = deleteTransaction;
    exports.addTransaction = addTransaction;
    var _default = transSlice.reducer;
    /*
